...
/**
 * REST controller for managing {@link uk.ac.bham.teamproject.domain.Inventory}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class InventoryResource {
    ...
    @PathVariable(value = "id", required = false) final Long id,
    @NotNull @RequestBody Inventory inventory) throws URISyntaxException {
...
Optional<Inventory> result = inventoryRepository.findById(inventory.getId())
...
;
    ...
    public List<Inventory> getAllInventories(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {        log.debug("REST request to get all Inventories");
        if (eagerload) {
